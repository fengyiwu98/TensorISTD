...
%%%%%%%获取图像的路徿%%%%%%%%
% 图像序列文件夹路徿
file_path = 'D:\研二上\code\benchmark合集\benchmark_release(wyl)\dataset\data\data13\';
% 霿??获取图片的濦?°（这个数量要小于等于文件夹下图片濦?°）
img_num = 396;   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
png_res_base_path='D:\研二上\code\benchmark合集\benchmark_release(wyl)\png_results\data13\NPSTT\';
%% 参数的设罿
%%%%%%%%%以下参数可修政%%%%%%%%%%
patchSize = 70;  % patch 的大尿
slideStep = 70;  % 滑动窗口的步长
frame = 3;       % 前后各frame帿
patchNum = 3;    % patchNum * patchNum 丿patches＿个patch丿?·＿
curframe = 20;   % 当前帧位罿
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
